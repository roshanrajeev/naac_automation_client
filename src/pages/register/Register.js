                    ...
                    <form className={styles.register_form} onSubmit={this.handleSubmit}>
                        <div className={styles.name}>
                            <div className={styles.firstname}>
                                ...
                                <input className={styles.inputstyle} type="text" name="firstname" placeholder='Enter Firstname' onChange={this.handleChange}/>
                            </div>
                            <div className={styles.lastname}>
                                <label className={styles.label}>Last Name</label>
                                <input className={styles.inputstyle} type="text" name="lastname" placeholder='Enter Lastname' onChange={this.handleChange}/>
                            </div>
                        </div>
                        {/* Email */}
                        ...
                        <input className={styles.inputstyle} type="password" name="password2" placeholder='Re-enter Password' onChange={this.handleChange}/>
